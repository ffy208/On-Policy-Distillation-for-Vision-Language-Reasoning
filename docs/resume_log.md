...
- [pending full run] SFT student accuracy and format rate on the 500-question test set; delta versus the 0.668 baseline; full-run acceptance rate over 3000 questions; total training time.
